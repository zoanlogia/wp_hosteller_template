                    ...
                    <div class="item-wrapper d-sm-flex flex-wrap flex-lg-nowrap align-items-lg-center">
                        <div class="booking_group d-flex flex-column">
                            ...
                            <div class="booking_group-wrapper">
                                ...
                                <input class="booking_group-field field required" data-type="date" data-start="true" type="text" id="checkIn" value="Add date" readonly />
                        ...
                        <div class="booking_group d-flex flex-column">
                            ...
                            <div class="booking_group-wrapper">
                                <i class="icon-calendar icon"></i>
                                <input class="booking_group-field field required" data-type="date" data-end="true" type="text" id="checkOut" value="Add date" readonly />
                                <i class="icon-chevron_down icon"></i>
                            </div>
                        </div>
                        <div class="booking_group d-flex flex-column">
                            ...
                            <div class="booking_group-wrapper booking_group-wrapper--guests">
                                ...
                                <div class="booking_group-field dropdown-toggle" role="presentation" id="guests" data-bs-toggle="collapse" data-bs-target="#bookingDropdown"></div>
                ...
                <li class="rating_list-item col-12 col-sm-6 col-xl-3" data-order="3" data-aos="zoom-in">
                    ...
                    <div class="media">
                        <svg width="98" height="32" viewBox="0 0 98 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M94.5141 19.5423L97.2244 21.3491C96.3448 22.6448 94.2407 24.8677 90.6033 24.8677C86.0862 24.8677 82.7222 21.3729 82.7222 16.9271C82.7222 12.1961 86.1219 8.98657 90.2229 8.98657C94.3477 8.98657 96.3685 12.2674 97.0223 14.0386L97.3789 14.942L86.7519 19.3402C87.5602 20.9331 88.8202 21.7414 90.6033 21.7414C92.3864 21.7414 93.6226 20.8618 94.5141 19.5423ZM86.1813 16.6775L93.2779 13.7295C92.8856 12.7429 91.7207 12.0416 90.3299 12.0416C88.5587 12.0416 86.0981 13.6106 86.1813 16.6775Z" fill="#FF302F" />
                            <path d="M77.5991 0.891602H81.0226V24.1427H77.5991V0.891602Z" fill="#20B15A" />
                            <path d="M72.2024 9.60487H75.507V23.7267C75.507 29.587 72.0478 32.0001 67.9587 32.0001C64.1073 32.0001 61.7893 29.4087 60.9215 27.3047L63.9527 26.0447C64.4995 27.3404 65.819 28.8738 67.9587 28.8738C70.5857 28.8738 72.2024 27.2453 72.2024 24.2022V23.061H72.0835C71.2989 24.012 69.8012 24.8679 67.8992 24.8679C63.9289 24.8679 60.2915 21.4087 60.2915 16.9511C60.2915 12.4697 63.9289 8.97485 67.8992 8.97485C69.7893 8.97485 71.2989 9.81884 72.0835 10.746H72.2024V9.60487ZM72.4401 16.9511C72.4401 14.1457 70.5738 12.1012 68.1964 12.1012C65.7952 12.1012 63.7744 14.1457 63.7744 16.9511C63.7744 19.7208 65.7952 21.7297 68.1964 21.7297C70.5738 21.7416 72.4401 19.7208 72.4401 16.9511Z" fill="#3686F7" />
                            <path d="M41.4978 16.8914C41.4978 21.4679 37.9317 24.832 33.5573 24.832C29.1828 24.832 25.6167 21.4561 25.6167 16.8914C25.6167 12.2911 29.1828 8.93896 33.5573 8.93896C37.9317 8.93896 41.4978 12.2911 41.4978 16.8914ZM38.0268 16.8914C38.0268 14.0385 35.9585 12.0772 33.5573 12.0772C31.1561 12.0772 29.0877 14.0385 29.0877 16.8914C29.0877 19.7205 31.1561 21.7057 33.5573 21.7057C35.9585 21.7057 38.0268 19.7205 38.0268 16.8914Z" fill="#FF302F" />
                            <path d="M58.8411 16.9271C58.8411 21.5037 55.275 24.8677 50.9005 24.8677C46.5261 24.8677 42.96 21.5037 42.96 16.9271C42.96 12.3268 46.5261 8.98657 50.9005 8.98657C55.275 8.98657 58.8411 12.315 58.8411 16.9271ZM55.3582 16.9271C55.3582 14.0742 53.2898 12.1129 50.8886 12.1129C48.4874 12.1129 46.4191 14.0742 46.4191 16.9271C46.4191 19.7563 48.4874 21.7414 50.8886 21.7414C53.3017 21.7414 55.3582 19.7444 55.3582 16.9271Z" fill="#FFBA40" />
                            <path d="M12.5646 21.3848C7.58395 21.3848 3.68499 17.367 3.68499 12.3863C3.68499 7.40565 7.58395 3.38782 12.5646 3.38782C15.2511 3.38782 17.2125 4.44577 18.6627 5.80089L21.052 3.41159C19.0312 1.474 16.3328 0 12.5646 0C5.74146 0 0 5.56315 0 12.3863C0 19.2095 5.74146 24.7727 12.5646 24.7727C16.2496 24.7727 19.0312 23.5602 21.2065 21.3016C23.4413 19.0669 24.1308 15.9287 24.1308 13.3848C24.1308 12.5884 24.0357 11.7682 23.9287 11.162H12.5646V14.4666H20.6597C20.422 16.5349 19.7682 17.9495 18.8053 18.9123C17.6404 20.0892 15.7979 21.3848 12.5646 21.3848Z" fill="#3686F7" />
                        </svg>
                    </div>
                </li>
                        ...
                        <li class="list-item d-flex align-items-sm-center" data-aos="fade-up">
                            <div class="media theme-element theme-element--accent">
                                <svg width="40" height="38" viewBox="0 0 40 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M3.96463 25.5012H5.74978C6.38096 25.5012 6.89263 25.0001 6.89263 24.3818V22.6333C6.89263 22.0151 6.38096 21.5139 5.74978 21.5139H3.96463C3.33345 21.5139 2.82178 22.0151 2.82178 22.6333V24.3818C2.82178 25.0001 3.33345 25.5012 3.96463 25.5012ZM3.96463 24.3818V22.6333H5.74978V24.3818H3.96463Z" fill="currentColor" />
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M3.96463 32.5326H5.74978C6.38096 32.5326 6.89263 32.0314 6.89263 31.4131V29.6641C6.89263 29.0459 6.38096 28.5447 5.74978 28.5447H3.96463C3.33345 28.5447 2.82178 29.0459 2.82178 29.6641V31.4131C2.82178 32.0314 3.33345 32.5326 3.96463 32.5326ZM3.96463 31.4131V29.6641H5.74978V31.4131H3.96463Z" fill="currentColor" />
                                </svg>
                            </div>
                            <div class="main">
